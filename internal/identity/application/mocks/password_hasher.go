...
func (_mock *PasswordHasher) Compare(hashedPassword string, password string) error {
...
func (_c *PasswordHasher_Compare_Call) RunAndReturn(run func(hashedPassword string, password string) error) *PasswordHasher_Compare_Call {
	_c.Call.Return(run)
	return _c
}
